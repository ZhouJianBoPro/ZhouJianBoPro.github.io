...
![脏读示例](https://github.com/ZhouJianBoPro/ZhouJianBoPro.github.io/blob/master/images/dirtyRead.png)

<font color="#0000dd">不可重复读：A事物读取了B事物已提交更改的数据：</font>
![不可重复读示例](https://github.com/ZhouJianBoPro/ZhouJianBoPro.github.io/blob/master/images/unrepeatableRead.png)

<font color="#660066">幻读：A事物读取了B事物已提交新增的数据：</font>
![幻读示例](https://github.com/ZhouJianBoPro/ZhouJianBoPro.github.io/blob/master/images/fantasyRead.png)
