...
<span id="publish/subscribe"><font color="#dd0000">发布/订阅模式</font><br /></span><br/>
...
```
5.direct模式Consumer接收消息:不用重新声明和绑定queue，用Producer的queue即可<br/>

6.广播模式Consumer接收消息：重新声明queue及绑定producer中的exchange(在Producer中没有声明queue)
```java
...
<span id="topics"><font color="#dd0000">通配符模式</font><br /></span><br/>
